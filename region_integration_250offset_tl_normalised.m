...
%S1_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S1_250 = squeeze(sum(sum(SImage,1),2));
...
%S2_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S2_250 = squeeze(sum(sum(SImage,1),2));
%% Region 3
...
%S3_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S3_250 = squeeze(sum(sum(SImage,1),2));
%% Region 4
...
%S4_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S4_250 = squeeze(sum(sum(SImage,1),2));
...
%S5_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S5_250 = squeeze(sum(sum(SImage,1),2));
...
%S6_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S6_250 = squeeze(sum(sum(SImage,1),2));
...
%S7_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S7_250 = squeeze(sum(sum(SImage,1),2));
...
%S8_250 = squeeze(sum(sum(SImage,1),2))/sum(sum(temp>0));
S8_250 = squeeze(sum(sum(SImage,1),2));
%%
close all
