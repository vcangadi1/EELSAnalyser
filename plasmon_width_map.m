function Wp_map = plasmon_width_map(EELS)
%% PARALLEL ROUTINE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input :
...
%
% Output:
%    Wp_map - Plasmon width map. Each pixel value is plasmon position value of
...
Wp_map = zeros(EELS.SI_x,EELS.SI_y);
...
parfor ii = 1:EELS.SI_x
    ...
    Wp_map(ii,:) = arrayfun(@(jj) plasmon_fit(llow,S(ii,jj)), c.Value);
