...
[f_main, gof_main, opt_main] = Exponential_fit(l(36:71),S(36:71));
...
% onset.
[f_later, gof_later, opt_later] = Exponential_fit(l(295:end),S(295:end));
...
legend('pre-edge exp fit (crosses spectrum)(Under estimate)',...
    'pre-edge exp fit (not crossing spectrum)',...
    'tail exp fit & shift to onset (crosses zero axis)',...
    'tail exp fit & shift to onset (not crossing zero axis)(Over estimate)');
grid on
box on