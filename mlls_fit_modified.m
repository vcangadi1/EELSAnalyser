function [p, R2, fun, back] = mlls_fit_modified(core_loss_spectrum, energy_loss_HIGH_LOSS, model_begin_channel, model_end_channel, Fit_Type, Diff_cross_sections, Optional_lowloss_spectrum)
%%
