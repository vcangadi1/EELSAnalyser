...
[f_main, gof_main, opt_main] = Exponential_fit(l(1:265),S(1:265));
...
% edge onset
[f_later, gof_later, opt_later] = Exponential_fit(l(373:476),S(373:476));
...
legend('pre-edge exp fit (Over estimate)',...
    'tail exp & shift (Under estimate)',...
    'spectrun');
grid on
box on