function [GaN, InN, InGaN] = referenced_InGaN(filename, startRow, endRow)
...
InN = cell2mat(raw(:, 6));
%{
InGaN(:,1) = cell2mat(raw(:, 8));
InGaN(:,2) = cell2mat(raw(:, 10));
InGaN(:,3) = cell2mat(raw(:, 12));
InGaN(:,4) = cell2mat(raw(:, 14));
InGaN(:,5) = cell2mat(raw(:, 16));
InGaN(:,6) = cell2mat(raw(:, 18));
InGaN(:,7) = cell2mat(raw(:, 20));
InGaN(:,8) = cell2mat(raw(:, 22));
InGaN(:,9) = cell2mat(raw(:, 24));
%}
InGaN = cell2mat(raw(:, 8:2:24));
