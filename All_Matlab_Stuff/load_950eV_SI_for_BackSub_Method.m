...
load('/Users/veersaysit/Desktop/EELS data/Ge-basedSolarCell_24082015/tl_nozero.mat');
EELS = change_dimension(EELS,90,44);
EELS.SImage = EELS.SImage./2./repmat(tl,1,1,EELS.SI_z); %normalise exposure time
