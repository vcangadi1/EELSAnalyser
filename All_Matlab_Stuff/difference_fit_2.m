...
for m=1:r,
    for n=1:c,
        ...
        ds(N) = EELS(N);
        ds = (reshape(ds,N,1));
        [fitresult, gof] = exp2((1:100).', ds(1:100));
        nY = fitresult(nX);
        ...
        [fitresult, gof] = exp2((10:160).', core(10:160));
        cf1 = fitresult(nX);
        [fitresult, gof] = exp2((1:20).', EELS_spectrum(1:20));
        cf2 = fitresult(nX);
        curvef = EELS_spectrum;
        [fitresult, gof] = exp2((100:150).', EELS_spectrum(100:150));
        cf3 = fitresult(nX);
        for i=1:N,
...
%%  Plot the figures
figure;
plot(curvef,'r','LineWidth',3)
hold on
plot(EELS_spectrum-curvef,'g','LineWidth',3)
