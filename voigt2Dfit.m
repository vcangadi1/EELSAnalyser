...
if nargin < 2
    ...
    p0 = [1E9,186,132,611,577,0.5];
    lb = [100,150,100,10,1,0,];
    ub = [1E10,200,200,1000,1000,1];
elseif nargin < 3
    [c,r] = meshgrid(1:x,r_axis);
    p0 = [1E9,186,0,1,1,0.5];
    lb = [100,150,-1,0,0,0];
    ub = [1E10,200,1,1000,1000,1];
elseif nargin < 4
    [c,r] = meshgrid(c_axis,r_axis);
    p0 = [1E5,0,0,0.001,0.001,0.005,1E5];
    lb = [1E4,-0.5,-0.5,0,0,0,1E0];
    ub = [1E10,0.5,0.5,0.01,0.01,0.1,1E10];
end
